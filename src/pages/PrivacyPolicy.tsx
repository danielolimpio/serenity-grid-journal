...
const PrivacyPolicy = () => {
  const tableOfContents = [
    { id: "info-coletamos", title: "Que informações coletamos?" },
    { id: "processamento", title: "Como processamos suas informações?" },
    { id: "bases-legais", title: "Em que bases legais nos apoiamos?" },
    { id: "compartilhamento", title: "Quando e com quem compartilhamos?" },
    { id: "sites-terceiros", title: "Nossa posição sobre sites de terceiros" },
    { id: "cookies", title: "Cookies e tecnologias de rastreamento" },
    { id: "logins-sociais", title: "Logins em redes sociais" },
    { id: "retencao", title: "Por quanto tempo guardamos suas informações?" },
    { id: "seguranca", title: "Como mantemos suas informações seguras?" },
    { id: "menores", title: "Coletamos informações de menores?" },
    { id: "direitos", title: "Quais são seus direitos de privacidade?" },
    { id: "dnt", title: "Controles para recursos de não rastrear" },
    { id: "eua", title: "Direitos específicos para residentes dos EUA" },
    { id: "outras-regioes", title: "Outras regiões com direitos específicos" },
    { id: "atualizacoes", title: "Atualizamos este aviso?" },
    { id: "contato", title: "Como entrar em contato conosco?" },
    { id: "revisar-dados", title: "Como revisar, atualizar ou excluir seus dados?" },
  ];
      ...
      <main className="pt-32">
        ...
        <section className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="bg-card rounded-lg p-8 md:p-12 shadow-soft border border-border/50">
              <div className="flex items-start gap-4 mb-6">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/20 flex items-center justify-center">
                  <FileText className="w-6 h-6 text-accent-foreground" />
                </div>
                <div>
                  <h2 className="font-display text-2xl font-light mb-4">Quando este Aviso se aplica?</h2>
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      Este Aviso de Privacidade se aplica quando você:
                    </p>
          ...
          <div className="container-editorial">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {keyPoints.map((point, index) => (
                <div 
                  key={index}
                  className="bg-card p-6 rounded-lg shadow-soft border border-border/30 hover:shadow-medium transition-editorial"
                >
        ...
        <section className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="bg-card rounded-lg p-8 md:p-10 shadow-soft border border-border/50">
              <h2 className="font-display text-2xl md:text-3xl font-light mb-8 text-center">Índice</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {tableOfContents.map((item, index) => (
                  <a 
                    key={item.id}
                    href={`#${item.id}`}
                    className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted/50 transition-editorial group"
                  >
                    <span className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-sm font-medium text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-editorial">
                      {index + 1}
                    </span>
                    <span className="text-sm text-muted-foreground group-hover:text-foreground transition-editorial">
                      {item.title}
                    </span>
                  </a>
                ))}
        ...
        {/* Section 1 */}
        <section id="info-coletamos" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">1</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Que Informações Coletamos?</h2>
            </div>

            <div className="space-y-8">
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <div className="flex items-start gap-4 mb-6">
                  <Database className="w-6 h-6 text-primary flex-shrink-0" />
                  <div>
                    <h3 className="font-display text-xl font-light mb-2">Informações pessoais que você nos divulga</h3>
                    <p className="text-sm text-muted-foreground italic mb-4">Resumindo: Coletamos informações pessoais que você nos fornece.</p>
                  </div>
                </div>
                
                <div className="prose-editorial space-y-4 text-muted-foreground">
                  <p>
                  ...
                  <h4 className="font-display text-lg text-foreground mt-6 mb-3">Informações pessoais fornecidas por você</h4>
                  <p>
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <div className="flex items-start gap-4 mb-4">
                  <ShieldCheck className="w-6 h-6 text-accent-foreground flex-shrink-0" />
                  <div>
                    <h4 className="font-display text-lg font-light mb-2">Informação sensível</h4>
                    <p className="text-muted-foreground">
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h4 className="font-display text-lg font-light mb-2">Dados de login de redes sociais</h4>
        ...
        {/* Section 2 */}
        <section id="processamento" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">2</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Como Processamos Suas Informações?</h2>
            </div>
        ...
        {/* Section 3 */}
        <section id="bases-legais" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">3</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Em Que Bases Legais Nos Apoiamos?</h2>
            </div>
                ...
                <div className="prose-editorial space-y-4 text-muted-foreground">
                  ...
                  <div className="space-y-4 mt-6">
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium text-foreground">Consentimento</p>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium text-foreground">Obrigações Legais</p>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      <Shield className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="font-medium text-foreground">Interesses vitais</p>
        ...
        {/* Section 4 */}
        <section id="compartilhamento" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">4</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Quando e Com Quem Compartilhamos?</h2>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
              ...
              <div className="prose-editorial space-y-4 text-muted-foreground">
                ...
                <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg mt-4">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Transferências de Negócios</p>
        ...
        {/* Section 5 */}
        <section id="sites-terceiros" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">5</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Nossa Posição Sobre Sites de Terceiros</h2>
            </div>
        ...
        {/* Section 6 */}
        <section id="cookies" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">6</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Cookies e Tecnologias de Rastreamento</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-display text-xl font-light">Google Analytics</h3>
                </div>
        ...
        {/* Section 7 */}
        <section id="logins-sociais" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">7</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Logins em Redes Sociais</h2>
            </div>
        ...
        {/* Section 8 */}
        <section id="retencao" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">8</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Por Quanto Tempo Guardamos Suas Informações?</h2>
            </div>
        ...
        {/* Section 9 */}
        <section id="seguranca" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">9</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Como Mantemos Suas Informações Seguras?</h2>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
              ...
              <div className="prose-editorial space-y-4 text-muted-foreground">
                <p>
                  Implementamos medidas técnicas apropriadas e razoáveis, organizacionais e implementamos medidas de segurança para proteger a segurança de quaisquer informações pessoais que processamos. No entanto, apesar de nossas medidas de segurança e esforços para proteger suas informações, nenhuma transmissão eletrônica pela Internet ou tecnologia de armazenamento de informações pode ser garantida como 100% segura.
                </p>
                
                <p>
                  Portanto, não podemos prometer ou garantir que hackers, cibercriminosos ou outros agentes maliciosos não consigam acessar ou acessar suas informações, não poderão burlar nossa segurança nem coletar, acessar, roubar ou modificar suas informações indevidamente. Embora façamos o possível para proteger suas informações pessoais, a transmissão de informações pessoais de e para nossos Serviços é de sua inteira responsabilidade. Você deve acessar os Serviços somente em um ambiente seguro.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Section 10 */}
        <section id="menores" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">10</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Coletamos Informações de Menores?</h2>
            </div>
        ...
        {/* Section 11 */}
        <section id="direitos" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">11</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Quais São Seus Direitos de Privacidade?</h2>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                ...
                <div className="prose-editorial space-y-4 text-muted-foreground">
                  ...
                  <ul className="space-y-3 mt-4">
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-medium text-primary">i</span>
                      <span>solicitar acesso e obter uma cópia de suas informações pessoais</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-medium text-primary">ii</span>
                      <span>solicitar a retificação ou o apagamento</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-medium text-primary">iii</span>
                      <span>restringir o processamento de suas informações pessoais</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-medium text-primary">iv</span>
                      <span>se aplicável, à portabilidade dos dados</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-medium text-primary">v</span>
                      <span>não ser submetido a decisões automatizadas</span>
                    </li>
                  </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-card rounded-lg p-6 shadow-soft border border-border/30">
                  <div className="flex items-center gap-3 mb-3">
                    <Globe className="w-5 h-5 text-primary" />
                    <h4 className="font-display text-lg font-light">EEE ou Reino Unido</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="bg-card rounded-lg p-6 shadow-soft border border-border/30">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-display text-lg font-light">Suíça</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                ...
                <div className="prose-editorial text-muted-foreground space-y-3">
                  <p>
        ...
        {/* Section 12 */}
        <section id="dnt" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">12</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Controles para Recursos de Não Rastrear</h2>
            </div>
        ...
        {/* Section 13 */}
        <section id="eua" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">13</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Direitos Específicos para Residentes dos EUA</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <h3 className="font-display text-xl font-light mb-6">Categorias de informações pessoais que coletamos</h3>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="text-left py-3 px-4 font-medium text-foreground">Categoria</th>
                        <th className="text-left py-3 px-4 font-medium text-foreground">Exemplos</th>
                        <th className="text-center py-3 px-4 font-medium text-foreground">Coletado</th>
                      </tr>
                    </thead>
                    <tbody>
                      {dataCategories.map((item, index) => (
                        <tr key={index} className="border-b border-border/50">
                          <td className="py-3 px-4 font-medium text-foreground align-top">{item.category}</td>
                          <td className="py-3 px-4 text-muted-foreground align-top">{item.examples}</td>
                          <td className="py-3 px-4 text-center align-top">
                            <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs ${item.collected ? 'bg-primary/20 text-primary' : 'bg-muted text-muted-foreground'}`}>
        ...
        {/* Section 14 */}
        <section id="outras-regioes" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">14</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Outras Regiões com Direitos Específicos</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                <div className="flex items-center gap-3 mb-4">
                  <Globe className="w-6 h-6 text-primary" />
                  <h3 className="font-display text-xl font-light">Austrália e Nova Zelândia</h3>
                </div>
                <div className="prose-editorial space-y-4 text-muted-foreground">
                  <p>
              ...
              <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
                ...
                <div className="prose-editorial space-y-4 text-muted-foreground">
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg mt-4">
                    <p className="font-medium text-foreground mb-2">Regulador de Informação (África do Sul)</p>
                    <ul className="space-y-1 text-sm">
                      <li>Para informações gerais: <a href="mailto:enquires@inforegulator.org.za" className="text-primary hover:underline">enquires@inforegulator.org.za</a></li>
                      <li>Reclamações (preencher o formulário POP/PAIA): <a href="mailto:PAIACComplaints@inforegulator.org.za" className="text-primary hover:underline">PAIACComplaints@inforegulator.org.za</a> e <a href="mailto:POPIAComplaints@inforegulator.org.za" className="text-primary hover:underline">POPIAComplaints@inforegulator.org.za</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        {/* Section 15 */}
        <section id="atualizacoes" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">15</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Atualizamos Este Aviso?</h2>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
              ...
              <div className="prose-editorial space-y-4 text-muted-foreground">
                <p>
                  Podemos atualizar este Aviso de Privacidade periodicamente. A versão atualizada será indicada por uma nova data de "Revisado" no topo deste Aviso de Privacidade. Caso façamos alterações substanciais a este Aviso de Privacidade, podemos notificá-lo por e-mail ou por meio de uma notificação em nosso site.
                </p>
                <p>
        ...
        <section id="contato" className="section-spacing">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">16</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Como Entrar em Contato Conosco?</h2>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 md:p-8 shadow-soft border border-border/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 bg-muted/50 rounded-lg">
                  ...
                  <a href="mailto:contato@theartofyoga.org" className="text-primary hover:underline">
        ...
        {/* Section 17 */}
        <section id="revisar-dados" className="section-spacing bg-muted/30">
          <div className="container-editorial max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-display text-primary">17</span>
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-light">Como Revisar, Atualizar ou Excluir Seus Dados?</h2>
            </div>
              ...
              <div className="prose-editorial space-y-4 text-muted-foreground">
                ...
                <div className="p-6 bg-primary/5 rounded-lg border border-primary/20 mt-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground mb-2">Solicitar acesso aos seus dados</p>
                      <p className="text-sm">
